-- HouseDraft: remove Made Jury scoring (+10).
-- Enum value MADE_JURY remains (Postgres cannot drop enum values safely);
-- it is no longer seeded or offered as a scoring rule.
-- No scoring_events used MADE_JURY at the time of this migration.
...
begin
  ...
  from (values
    ('HOH_WIN', 10), ('VETO_WIN', 8), ('VETO_USED', 4), ('SAVED_WITH_VETO', 4), ('DIAMOND_VETO_USED', 6),
    ('SURVIVED_EVICTION', 3),
    ('NOMINATED', -3), ('REPLACEMENT_NOMINEE', -2), ('EVICTED', -3),
    ('MADE_FINAL_5', 15), ('MADE_FINAL_3', 20), ('RUNNER_UP', 30), ('WINNER', 60),
    ('AMERICA_FAVORITE', 25), ('BLOCK_BUSTER_WIN', 8), ('MEDIEVAL_ROUND_WIN', 2),
...
delete from public.scoring_rules where event_type = 'MADE_JURY';
